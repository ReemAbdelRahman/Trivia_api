...
-- URI:- http://127.0.0.1:5000/categories/6
-- Response
    {
    "category": {
        "id": 6, 
...
-- Modifies the type of the category with the specified id
-- URI:- http://127.0.0.1:5000/categories/6
-- Response
    {
    "id": 6,
...
-- Returns all the categories and paginated questions in page 1 
...
-- Returns all the categories and paginated questions in page 2 
...
-- URI:- http://127.0.0.1:5000/questions/28
-- Response
    {
    "question": {
        "answer": "Let's see", 
...
-- Returns the questions based on a search term
-- URI:- http://127.0.0.1:5000/questions
-- Response
    {
  "related_questions": [
